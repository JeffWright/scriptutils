...
class ListExtensionTests {
    ...
    fun testSplit() {
        ...
        listOf(1, 2, 3, 4, 5).split { it == 3 || it == 4 } shouldBe listOf(listOf(1, 2), emptyList(), listOf(5))
        listOf(1, 2, 3, 4, 5).split { it == 5 } shouldBe listOf(listOf(1, 2, 3, 4), emptyList())

        listOf(1, 2, 3, 4, 5).split(ListSplitDelimiterOption.PREPEND) { it == 3 || it == 4 } shouldBe listOf(listOf(1, 2), listOf(3), listOf(4, 5))
        listOf(1, 2, 3, 4, 5).split(ListSplitDelimiterOption.APPEND) { it == 5 } shouldBe listOf(listOf(1, 2, 3, 4, 5), emptyList())
    }
